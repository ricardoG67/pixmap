...
def sift_n_fast(img_original):
    #An image decoded from b64 e.g:
    # b64 = image_to_base64(img_original)
    # Then b64 is decoded in pixmap.py line 41
    # And (ln44) img_np is sent to this function
    #
    #
    #pedir a la esan un dataset 
    #UP preguntar tmbn por si aca
    #
    #cambiar correo a pixmap en gmail
    #emprende up
